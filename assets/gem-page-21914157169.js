        ...
        jQuery(function() {
            var $hero = jQuery('#m-1537995595234');
            var $module = jQuery('#m-1537995595234').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1635176461590').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
        jQuery(function() {
            var $module = jQuery('#m-1537994189360').children('.module');
        });
    
(function( jQuery ){
  // var $module = jQuery('#m-1635176659692').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    jQuery(function() {
  var $module = jQuery('#m-1586610271920').children('.module');
