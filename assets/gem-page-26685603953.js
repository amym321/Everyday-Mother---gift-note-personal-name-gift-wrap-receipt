...
(function( jQuery ){
  // var $module = jQuery('#m-1635176827867').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
(function( jQuery ){
  // var $module = jQuery('#m-1635176842340').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
        jQuery(function() {
            var $module = jQuery('#m-1549043914579').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1549043914550').children('.module');
